...
const HomeBooks = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-5 justify-center px-16">
        {books.map((book) => (
          <div className="hover:bg-gray-50 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex justify-center">
            <div className="">
              <img
                className="p-2 rounded-t-lg w-52 "
                src={book.image}
                alt="product image"
              />
